    ...
    return (
        <>
            <Stack horizontal verticalAlign="center" tokens={stackTokens}>
                ...
                <IconButton id={iconButtonId} iconProps={iconProps} title="情報" ariaLabel="情報" onClick={toggleIsCalloutVisible} styles={iconButtonStyles} />
            </Stack>
            {isCalloutVisible && (
                <Callout target={"#" + iconButtonId} setInitialFocus onDismiss={toggleIsCalloutVisible} ariaDescribedBy={descriptionId} role="alertdialog">
                    <Stack tokens={stackTokens} horizontalAlign="start" styles={labelCalloutStackStyles}>
                        ...
                        <DefaultButton onClick={toggleIsCalloutVisible}>閉じる</DefaultButton>
                    </Stack>
                </Callout>
            )}
        </>
